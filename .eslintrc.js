  ...
  rules: {
    ...
    'no-restricted-syntax': [
      'error',
      {
        ...
        message: 'Hardcoded hex color found. Use a token from src/theme/tokens.ts instead.',
      },
      {
        selector: 'Literal[value=/^rgba?\\(/]',
        message: 'Hardcoded RGB/RGBA color found. Use a token from src/theme/tokens.ts instead.',
      },
    ],
